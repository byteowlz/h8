...
const EMBEDDED_NOUNS: &[&str] = &[
    ...
    "hate", "hats", "haul", "hawk", "haze", "hazy", "head", "heal", "heap", "heat", "heck", "heel",
    "heir", "held", "helm", "help", "hems", "herd", "here", "hero", "hick", "hide", "high", "hike",
    "hill", "hind", "hint", "hips", "hire", "hits", "hive", "hoax", "hobs", "hock", "hogs", "hold",
    "hole", "holy", "home", "hone", "honk", "hood", "hook", "hoop", "hope", "hops", "horn", "hose",
    "host", "hour", "hubs", "hues", "huff", "huge", "hugs", "hull", "hump", "hums", "hung", "hunk",
    "hunt", "hurt", "hush", "husk", "huts", "hymn", "hype", "iced", "icon", "idea", "idle", "idol",
    "iffy", "inch", "info", "inks", "inky", "inns", "into", "ions", "iris", "iron", "isle", "itch",
    "item", "jabs", "jack", "jade", "jail", "jams", "jars", "java", "jaws", "jazz", "jean", "jeer",
    "jell", "jerk", "jest", "jets", "jobs", "jock", "jogs", "join", "joke", "jolt", "jots", "jump",
    "june", "junk", "jury", "just", "keel", "keen", "keep", "kegs", "kelp", "kept", "kick", "kids",
    "kill", "kiln", "kilt", "kind", "king", "kiss", "kite", "kits", "knee", "knit", "knob", "knot",
    "know", "labs", "lace", "lack", "lacy", "lads", "lady", "lags", "laid", "lair", "lake", "lamb",
    "lame", "lamp", "land", "lane", "laps", "lard", "lark", "last", "late", "lava", "lawn", "laws",
    "lays", "lazy", "lead", "leaf", "leak", "lean", "leap", "left", "legs", "lend", "lens", "lent",
    "less", "liar", "lice", "lick", "lids", "lien", "lies", "life", "lift", "like", "limb", "lime",
    "limp", "line", "link", "lint", "lion", "lips", "list", "lite", "live", "load", "loaf", "loan",
    "lobe", "lobs", "lock", "loco", "loft", "logo", "logs", "lone", "long", "look", "loom", "loop",
    "loot", "lord", "lore", "lose", "loss", "lost", "lots", "loud", "lout", "love", "luck", "lull",
    "lump", "lung", "lure", "lurk", "lush", "lust", "luxe", "lynx",
];
